...
import static com.alexsav.stayfit.BuildConfig.MAPS_URL;

public class MapsUtils {
    private static final String MAPS_BASE_URL = MAPS_URL;
    ...
    public static URL buildNearbySearchUrl(String curLocation) {
        Uri uri = Uri
                .parse(MAPS_BASE_URL)
                .buildUpon()
                .appendPath(OUTPUT_JSON)
                .appendQueryParameter(LOCATION, curLocation)
